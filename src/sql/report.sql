...
--(10) add n-to-m relation to database that saves the data of type “single teacher can teach several classes.
--Save the info of the type, what teachers are teaching what classes”
